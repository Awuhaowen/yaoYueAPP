					...
					<view class="c" v-show="t">
						...
						<view class="lxr" v-show="shiJian">
							<view @tap="detail(item)">
								...
								<p :class="[item.qr == '空闲' ? 'pq' : item.qr == '已预约' ? 'yyy' : '']">
									{{ item.qr }}
								</p>
							</view>
							...
							<view class="btn">
								...
								<button size="mini" @tap="q(item)" :class="[item.qx == '取消' ? 'q1' : '']">
									{{ item.qx }}
								</button>
							</view>
						</view>
						...
						<view v-show="true ? item.qr == '空闲' : ''">
							<view class="zanWu">
								<view><image src="../../static/images/zanWu.png" mode="widthFix"></image></view>
								<p>暂无预约</p>
							</view>
						</view>
					</view>
					...
					d3: [
						{
							...
							phone: '010-149146124',
							qr: '待确认',
							p1: '简介：主论坛拟由双方主办单位负责人作主旨发言经济团体及企代表发言 ',
							js: '接受',
							qx: '拒绝',
							t1: '15:00-15:15'
						},
